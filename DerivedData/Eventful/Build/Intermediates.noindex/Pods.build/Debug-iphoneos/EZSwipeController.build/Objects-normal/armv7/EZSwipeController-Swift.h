...
SWIFT_MODULE_NAMESPACE_PUSH("EZSwipeController")
...
@protocol EZSwipeControllerDataSource
- (NSArray<UIViewController *> * _Nonnull)viewControllerData SWIFT_WARN_UNUSED_RESULT;
@optional
- (NSInteger)indexOfStartingPage SWIFT_WARN_UNUSED_RESULT;
- (NSArray<NSString *> * _Nonnull)titlesForPages SWIFT_WARN_UNUSED_RESULT;
- (UINavigationBar * _Nonnull)navigationBarDataForPageIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (BOOL)disableSwipingForLeftButtonAtPageIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (BOOL)disableSwipingForRightButtonAtPageIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
