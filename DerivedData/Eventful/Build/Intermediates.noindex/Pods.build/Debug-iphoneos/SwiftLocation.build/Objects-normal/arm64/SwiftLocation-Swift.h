...
SWIFT_MODULE_NAMESPACE_PUSH("SwiftLocation")





@interface CLLocationManager (SWIFT_EXTENSION(SwiftLocation))
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL isBackgroundUpdateEnabled;)
+ (BOOL)isBackgroundUpdateEnabled SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC13SwiftLocation15LocationTracker")
@interface LocationTracker : NSObject <CLLocationManagerDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
/// Callback called when a new request is added
@property (nonatomic, copy) void (^ _Nullable onAddNewRequest)(id _Nonnull);
/// Callback called when a request was removed
@property (nonatomic, copy) void (^ _Nullable onRemoveRequest)(id _Nonnull);
/// On Receive new location
@property (nonatomic, copy) void (^ _Nullable onReceiveNewLocation)(CLLocation * _Nonnull);
...
/// When <code>true</code> this property is a good way to improve battery life.
/// This function also scan for any running Request’s <code>activityType</code> and see if location data is unlikely to change.
/// If yes (for example when user stops for food while using a navigation app) the location manager might pause updates
/// for a period of time.
/// By default is set to <code>false</code>.
@property (nonatomic) BOOL autoPauseUpdates;
